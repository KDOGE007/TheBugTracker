...
namespace TheBugTracker.Controllers
{
    public class TicketAttachmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,MyProperty,TicketId,Created,UserID,Description,FileName,FileData,FileContentType")] TicketAttachment ticketAttachment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,MyProperty,TicketId,Created,UserID,Description,FileName,FileData,FileContentType")] TicketAttachment ticketAttachment)
        {
