...
namespace TheBugTracker.Controllers
{
    public class TicketsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Tickets.Include(t => t.DeveloperUser).Include(t => t.OwnerUser).Include(t => t.TicketPriority).Include(t => t.TicketStatus).Include(t => t.TicketType).Include(t => t.project);
